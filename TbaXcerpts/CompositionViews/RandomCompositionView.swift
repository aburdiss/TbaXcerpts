...
struct RandomCompositionView: View {
     ...
     */
    let allCompositions = TubaContentModel().excerpts
     ...
     */
    @State var randomComposition: Composition = berliozFaust
    
    /**
     The index of the random excerpt from the allCompositions or favoriteCompositions array
     */
